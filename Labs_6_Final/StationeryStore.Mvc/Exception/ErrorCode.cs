...
public static class ErrorCodeData
{
    private static readonly Dictionary<ErrorCode, (int Code, string Message, HttpStatusCode HttpStatus)> _map = new()
    {
        ...
        {ErrorCode.CONCURRENCY_CONFLICT, (1008, "There has a concurrency conflict", HttpStatusCode.BadRequest)},
        {ErrorCode.UNKNOWN_PROVIDER, (1009, "Unknown provider", HttpStatusCode.BadRequest)},
        {ErrorCode.NOT_EXISTED_CART, (1010, "Cart has not existed", HttpStatusCode.NotFound)},
        {ErrorCode.EMPTY_CART_ITEM, (1011, "The Cart Item is empty", HttpStatusCode.NotFound)},
        {ErrorCode.NOT_EXISTED_USER, (1011, "User has not existed", HttpStatusCode.NotFound)}
    };
